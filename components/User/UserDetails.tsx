  ...
  return (
    <div
      className={`md:flex my-10 items-center
            xsm:px-6 md:px-10 lg:px-20 accent-border p-10 accent-modal-bg rounded-md
          `}
    >
      <div className="basis-1/5 flex flex-row items-center justify-center">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 grid-rows-1 place-items-center">
            <div className="z-30 col-span-full row-span-full xsm:ring-2 lg:ring-4 ring-primary ring-opacity-40 rounded-full xsm:w-20 md:w-28 lg:w-32 h-full"></div>
            <Image
          ...
          {/* Image Transform */}
          <h1
            className={`${montserrat.className} text-primary xsm:text-md md:text-lg font-semibold text-center mt-4`}
          >
            {username}
          </h1>
        </div>
      ...
      <div className="basis-4/5 md:mx-10">
        <h1
          className={`${montserrat.className} text-primary xsm:text-sm md:text-lg accent-border-bottom py-2 my-2`}
        >
          <span className="font-semibold">Email:</span> {email}
        </h1>
        <h1
          className={`${montserrat.className} text-primary xsm:text-sm md:text-lg py-2 my-2`}
        >
